...
if($conn->connect_error){
    ...
    $stmt = $conn->prepare("INSERT INTO course (`course_id`, `name`, `description`, `grade_id`)
    VALUES(?, ?, ?, ?)");
    $stmt->bind_param("issi",$courseid, $name, $desc, $gradeid);
    $stmt->execute();
    echo "<h1>" . $succ . "</h1>";
...
<body>
    <div id="page-wrap">
        ...
        <div class="modalpos">
            <a href="#openModal3"><button class="button-3">Add Course</button></a>
        </div>

        <div id="openModal3" class="modalDialog">
            <div><a href="course.php" title="Close" class="close">X</a>
                <h2>
                    <center>Add course</center>
                </h2>
                <br><br>
                <form action="course.php" method="POST">
                    <label class="formstyle">course ID:</label>
                    <input type="text" name="courseid" placeholder="Course ID"><br><br>
        ...
        <div class="tabs">
            ...
            <form action="delete.php" method="POST">
                ...
                <td><input class="button-4" type="submit" name="deleteCO" value="Delete"></td>
            </form>
            <?php
            echo "</tr>";
            }                
